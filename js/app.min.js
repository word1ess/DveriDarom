...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/index.esm.js\");\n\r\n\r\n\r\n// Plugins\r\n\r\n\r\n\r\n\r\nconst isMobile = window.screen.width < 992;\r\n\r\nfunction createAdaptiveSlider({\r\n  slider,\r\n  prevArrow,\r\n  nextArrow,\r\n  slides,\r\n  breakpointsSlides,\r\n  space = 0,\r\n  isLoop = false,\r\n  isCentered = false,\r\n  paginationBlock = false,\r\n  slidesPerGroup = 1,\r\n  delay = false,\r\n  ...props\r\n}) {\r\n  const swiperInstance = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"](slider, {\r\n    spaceBetween: space,\r\n    slidesPerView: slides,\r\n    loop: isLoop,\r\n    centeredSlides: isCentered,\r\n    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Autoplay],\r\n\r\n    breakpoints: {\r\n      320: {\r\n        slidesPerView: breakpointsSlides[0],\r\n        spaceBetween: 10,\r\n      },\r\n      577: {\r\n        slidesPerView: breakpointsSlides[1],\r\n        spaceBetween: 15,\r\n      },\r\n      1200: {\r\n        slidesPerView: breakpointsSlides[2],\r\n        spaceBetween: 15,\r\n      },\r\n      1281: {\r\n        slidesPerView: slides,\r\n        spaceBetween: space,\r\n      },\r\n    },\r\n\r\n    pagination: {\r\n      el: paginationBlock,\r\n      clickable: true,\r\n    },\r\n\r\n    // Navigation arrows\r\n    navigation: {\r\n      prevEl: prevArrow,\r\n      nextEl: nextArrow,\r\n    },\r\n    slidesPerGroup: isMobile ? 1 : slidesPerGroup,\r\n    autoplay: delay && {\r\n      delay,\r\n    },\r\n\r\n    ...props,\r\n  });\r\n\r\n  return swiperInstance;\r\n}\r\nfunction removeActiveClass(arr, activeClass) {\r\n  arr.forEach((el) => {\r\n    el.classList.remove(activeClass);\r\n  });\r\n}\r\nfunction slide(clicableBlock, hiddenBlock, activeClass) {\r\n  jquery__WEBPACK_IMPORTED_MODULE_0__(`${clicableBlock} button`).on(\"click\", function (e) {\r\n    e.preventDefault();\r\n    const $parent = jquery__WEBPACK_IMPORTED_MODULE_0__(this).parent();\r\n    $parent.toggleClass(activeClass);\r\n    $parent.next(hiddenBlock).slideToggle(300);\r\n  });\r\n}\r\nfunction closeDialogBox(container) {\r\n  jquery__WEBPACK_IMPORTED_MODULE_0__(container).fadeOut(300);\r\n}\r\nfunction clickForOpenDialogbox(btn, currentDialogbox, isEventDisable = false) {\r\n  btn.on(\"click\", function (e) {\r\n    !isEventDisable && e.preventDefault();\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__(`.dialogbox-${currentDialogbox}`).fadeIn(200);\r\n  });\r\n}\r\nfunction tabs(linksTab, blocksTab, activeClass = \"active\", activeIndex = 0) {\r\n  linksTab.forEach((link, i, arr) => {\r\n    link.addEventListener(\"click\", (e) => {\r\n      e.preventDefault();\r\n      changeActiveTabHandler(arr, blocksTab, i);\r\n    });\r\n  });\r\n  linksTab[activeIndex].classList.add(activeClass);\r\n  blocksTab[activeIndex].classList.add(activeClass);\r\n}\r\nconst changeActiveTabHandler = (links, blocks, activeIndex) => {\r\n  removeActiveClass(links, \"active\");\r\n  removeActiveClass(blocks, \"active\");\r\n  links[activeIndex].classList.add(\"active\");\r\n  blocks[activeIndex].classList.add(\"active\");\r\n};\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(\".dialogbox .dialogbox__close\").on(\"click\", function (e) {\r\n  e.preventDefault();\r\n  closeDialogBox(this.closest(\".dialogbox\"));\r\n});\r\njquery__WEBPACK_IMPORTED_MODULE_0__(\".dialogbox ._btn-close\").on(\"click\", function (e) {\r\n  e.preventDefault();\r\n  closeDialogBox(this.closest(\".dialogbox\"));\r\n});\r\njquery__WEBPACK_IMPORTED_MODULE_0__(\".dialogbox\").on(\"click\", function (e) {\r\n  e.stopImmediatePropagation();\r\n  if (e.target.classList.contains(\"dialogbox__inner\")) {\r\n    closeDialogBox(this);\r\n  }\r\n});\r\n\r\nconst buttonModals = document.querySelectorAll(\"[data-modal]\");\r\n\r\nbuttonModals?.forEach((btn) => {\r\n  clickForOpenDialogbox(jquery__WEBPACK_IMPORTED_MODULE_0__(btn), btn.dataset.modal);\r\n});\r\n\r\n// slide(\".slide__header\", \".slide__hidden\", \"active\");\r\nconst introSwiper = document.querySelector(\".intro-swiper .swiper\");\r\n\r\nif (introSwiper) {\r\n  const prevArrow = introSwiper.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = introSwiper.querySelector(\".swiper-button-next\");\r\n  createAdaptiveSlider({\r\n    slider: introSwiper,\r\n    prevArrow,\r\n    nextArrow,\r\n    slides: 1,\r\n    breakpointsSlides: [1, 1, 1, 1],\r\n  });\r\n}\r\n\r\nconst introSwiperImages = document.querySelectorAll(\r\n  \".intro-swiper__images .swiper\"\r\n);\r\n\r\nintroSwiperImages?.forEach((swiper) => {\r\n  const paginationBlock = swiper.querySelector(\".swiper-pagination\");\r\n\r\n  createAdaptiveSlider({\r\n    slider: swiper,\r\n    nextArrow: \"\",\r\n    prevArrow: \"\",\r\n    slides: 1,\r\n    breakpointsSlides: [1, 1, 1, 1],\r\n    paginationBlock,\r\n  });\r\n});\r\n\r\nconst indexDoorsTabsSwipers = document.querySelectorAll(\".index-doors\");\r\n\r\nindexDoorsTabsSwipers?.forEach((container) => {\r\n  const swiper = container.querySelector(\".swiper\");\r\n  const prevArrow = container.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = container.querySelector(\".swiper-button-next\");\r\n  const paginationBlock = container.querySelector(\".swiper-pagination\");\r\n\r\n  let swiperConfig = {\r\n    slider: swiper,\r\n    nextArrow,\r\n    prevArrow,\r\n    slides: 5,\r\n    breakpointsSlides: [2.1, 3, 4, 5],\r\n    space: 20,\r\n  };\r\n\r\n  if (isMobile) {\r\n    swiperConfig = {\r\n      ...swiperConfig,\r\n      paginationBlock,\r\n    };\r\n  }\r\n\r\n  createAdaptiveSlider(swiperConfig);\r\n});\r\n\r\nconst newsPageSwipers = document.querySelector(\".news-page-news\");\r\n\r\nif (newsPageSwipers) {\r\n  const swiper = newsPageSwipers.querySelector(\".swiper\");\r\n  const prevArrow = newsPageSwipers.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = newsPageSwipers.querySelector(\".swiper-button-next\");\r\n\r\n  let swiperConfig = {\r\n    slider: swiper,\r\n    nextArrow,\r\n    prevArrow,\r\n    slides: 3,\r\n    breakpointsSlides: [1.5, 2, 3, 3],\r\n    space: 20,\r\n  };\r\n\r\n  createAdaptiveSlider(swiperConfig);\r\n}\r\n\r\nconst photosSwiper = document.querySelector(\".photos\");\r\n\r\nif (photosSwiper) {\r\n  const swiper = photosSwiper.querySelector(\".swiper\");\r\n  const prevArrow = photosSwiper.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = photosSwiper.querySelector(\".swiper-button-next\");\r\n\r\n  createAdaptiveSlider({\r\n    slider: swiper,\r\n    nextArrow,\r\n    prevArrow,\r\n    slides: 4,\r\n    breakpointsSlides: [1.5, 2.5, 4, 4],\r\n    space: 20,\r\n  });\r\n}\r\n\r\nconst portfolioWorksSwiper = document.querySelector(\".portfolio-page-works\");\r\n\r\nif (portfolioWorksSwiper) {\r\n  const swiper = portfolioWorksSwiper.querySelector(\".swiper\");\r\n  const prevArrow = portfolioWorksSwiper.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = portfolioWorksSwiper.querySelector(\".swiper-button-next\");\r\n\r\n  createAdaptiveSlider({\r\n    slider: swiper,\r\n    nextArrow,\r\n    prevArrow,\r\n    slides: 1,\r\n    breakpointsSlides: [1, 1, 1, 1],\r\n    space: 20,\r\n  });\r\n}\r\n\r\nconst orderDoorsTabsSwipers = document.querySelectorAll(\r\n  \".order-page-swipers__swiper\"\r\n);\r\n\r\norderDoorsTabsSwipers?.forEach((container) => {\r\n  const swiper = container.querySelector(\".swiper\");\r\n  const prevArrow = container.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = container.querySelector(\".swiper-button-next\");\r\n\r\n  createAdaptiveSlider({\r\n    slider: swiper,\r\n    nextArrow,\r\n    prevArrow,\r\n    slides: 5,\r\n    breakpointsSlides: [1.5, 3, 4, 5],\r\n    space: 20,\r\n  });\r\n});\r\n\r\nconst showMoreSections = document.querySelectorAll(\".show-more\");\r\n\r\nshowMoreSections?.forEach((section) => {\r\n  const btn = section.querySelector(\"button\");\r\n\r\n  btn.onclick = () => {\r\n    section.classList.toggle(\"active\");\r\n  };\r\n});\r\n\r\nconst fileInputs = Array.from(document.querySelectorAll(\".custom-file\"));\r\nfileInputs.forEach((container) => {\r\n  const fileInput = container.querySelector(\"#file\");\r\n  const fileText = container.querySelector(\"span\");\r\n  const fileRemove = container.querySelector(\".custom-file-remove\");\r\n\r\n  fileInput.addEventListener(\"change\", function () {\r\n    let fileName = Array.from(this.files)[0].name;\r\n    fileText.textContent = fileName || \"Прикрепить .jpg .png .heik\";\r\n\r\n    fileName\r\n      ? fileRemove.classList.add(\"active\")\r\n      : fileRemove.classList.remove(\"active\");\r\n  });\r\n\r\n  fileRemove.onclick = (e) => {\r\n    e.preventDefault();\r\n    fileInput.value = \"\";\r\n    fileText.textContent = \"Прикрепить .jpg .png .heik\";\r\n    fileRemove.classList.remove(\"active\");\r\n  };\r\n});\r\n\r\n_fancyapps_ui__WEBPACK_IMPORTED_MODULE_3__.Fancybox.bind(\"[data-fancybox]\", {\r\n  autoResize: true,\r\n  autoScale: true,\r\n  fitToView: true,\r\n  width: \"100%\",\r\n  height: \"100%\",\r\n  maxWidth: \"100%\",\r\n  maxHeight: \"100%\",\r\n});\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(\".header-catalog\").on(\"click\", function (e) {\r\n  e.stopImmediatePropagation();\r\n  if (e.target.classList.contains(\"header-catalog\")) {\r\n    closeDialogBox(this);\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__(\".header__burger\").removeClass(\"burger-active\");\r\n  }\r\n});\r\njquery__WEBPACK_IMPORTED_MODULE_0__(\"._burger-catalog\").on(\"click\", function (e) {\r\n  e.preventDefault();\r\n\r\n  isMobile\r\n    ? jquery__WEBPACK_IMPORTED_MODULE_0__(\".header-mobile-menu\").fadeToggle(300)\r\n    : jquery__WEBPACK_IMPORTED_MODULE_0__(\".header-catalog\").fadeToggle(300);\r\n  jquery__WEBPACK_IMPORTED_MODULE_0__(this).toggleClass(\"active\");\r\n});\r\n\r\nfunction hoverSubLinks({ links, blocks, isMainLinks = false }) {\r\n  links[0].classList.add(\"active\");\r\n  blocks[0].classList.add(\"active\");\r\n  links.forEach((link, i) => {\r\n    link.addEventListener(\"mouseenter\", () => {\r\n      removeActiveClass(links, \"active\");\r\n      removeActiveClass(blocks, \"active\");\r\n\r\n      link.classList.add(\"active\");\r\n\r\n      blocks[i]?.classList.add(\"active\");\r\n    });\r\n  });\r\n}\r\n\r\nhoverSubLinks({\r\n  links: Array.from(document.querySelectorAll(\"._links-main a\")),\r\n  blocks: Array.from(\r\n    document.querySelectorAll(\"._links-sub .header-catalog__sublink\")\r\n  ),\r\n});\r\nconst btnToTop = document.querySelector(\".btn-fixed\");\r\nif (btnToTop) {\r\n  btnToTop.onclick = () => {\r\n    window.scrollTo({ top: 0, left: 0, behavior: \"smooth\" });\r\n  };\r\n}\r\n\r\nconst pageDropdowns = document.querySelectorAll(\".page-results__dropdown\");\r\n\r\npageDropdowns.forEach((container) => {\r\n  const input = container.querySelector(\"input\");\r\n  const headerText = container.querySelector(\r\n    \".page-results__dropdown-header span\"\r\n  );\r\n  const creditText = container.previousElementSibling;\r\n\r\n  if (creditText) {\r\n    creditText.textContent =\r\n      container.querySelectorAll(\"button\")[0].dataset?.value;\r\n  }\r\n\r\n  container.addEventListener(\"click\", (e) => {\r\n    const btn = e.target.closest(\"button\");\r\n    if (!btn) return;\r\n\r\n    e.preventDefault();\r\n\r\n    const btnTextValue = btn.textContent.trim();\r\n    const btnDataValue = btn.dataset.value;\r\n    let value = btnTextValue;\r\n\r\n    if (btnDataValue) {\r\n      value = value.concat(\" \", btnDataValue);\r\n      creditText.textContent = btnDataValue;\r\n    }\r\n\r\n    headerText.textContent = btnTextValue;\r\n    input.value = value;\r\n\r\n    container.querySelectorAll(\"button\").forEach((b) => {\r\n      b.classList.toggle(\"active\", b === btn);\r\n    });\r\n  });\r\n});\r\n\r\nif (isMobile) {\r\n  const headerDropdowns = document.querySelectorAll(\r\n    \".header-mobile-menu__header\"\r\n  );\r\n\r\n  headerDropdowns?.forEach((header) => {\r\n    const body = header.nextElementSibling;\r\n    const button = header.querySelector(\"button\");\r\n\r\n    button.onclick = () => {\r\n      header.classList.toggle(\"active\");\r\n      body.classList.toggle(\"active\");\r\n    };\r\n  });\r\n}\r\n\r\nconst itemCounters = Array.from(document.querySelectorAll(\".count\"));\r\n\r\nitemCounters?.forEach((countElement) => {\r\n  const minusButton = countElement.querySelector(\"button:first-child\");\r\n  const plusButton = countElement.querySelector(\"button:nth-child(3)\");\r\n  const maxCount = countElement.dataset.max;\r\n  const inputElement = countElement.querySelector('input[type=\"text\"]');\r\n\r\n  minusButton.addEventListener(\"click\", (e) => {\r\n    e.preventDefault();\r\n    let currentValue = parseInt(inputElement.value, 10);\r\n    if (isNaN(currentValue) || currentValue < 1) return (currentValue = 1);\r\n\r\n    inputElement.value = --currentValue;\r\n    logicAfterCalcutalteValue({\r\n      value: inputElement.value,\r\n    });\r\n  });\r\n\r\n  plusButton.addEventListener(\"click\", (e) => {\r\n    e.preventDefault();\r\n    let currentValue = parseInt(inputElement.value, 10);\r\n    if (isNaN(currentValue)) return (currentValue = 1);\r\n    if (currentValue >= maxCount) return (currentValue = maxCount);\r\n\r\n    inputElement.value = ++currentValue;\r\n    logicAfterCalcutalteValue({\r\n      value: inputElement.value,\r\n    });\r\n  });\r\n\r\n  const logicAfterCalcutalteValue = ({ value }) => {\r\n    inputElement.setAttribute(\"value\", value);\r\n    inputElement.dispatchEvent(new Event(\"change\", { bubbles: true }));\r\n  };\r\n});\r\n\r\nconst tabsContainers = document.querySelectorAll(\".tabs-blocks\");\r\n\r\ntabsContainers?.forEach((parent) => {\r\n  const links = parent.querySelectorAll(\".tabs-links a\");\r\n  const blocks = parent.querySelectorAll(\".tabs-block\");\r\n\r\n  tabs(links, blocks);\r\n});\r\n\r\nconst pageItemSwiper = document.querySelector(\r\n  \".page-intro-product__swiper .swiper\"\r\n);\r\n\r\nif (pageItemSwiper) {\r\n  const prevArrow = pageItemSwiper.querySelector(\".swiper-button-prev\");\r\n  const nextArrow = pageItemSwiper.querySelector(\".swiper-button-next\");\r\n  createAdaptiveSlider({\r\n    slider: pageItemSwiper,\r\n    prevArrow,\r\n    nextArrow,\r\n    slides: 1,\r\n    breakpointsSlides: [1, 1, 1, 1],\r\n  });\r\n}\r\n\r\nconst pageItemsColorsContainer = document.querySelector(\r\n  \".page-intro-product__colors\"\r\n);\r\n\r\nif (pageItemsColorsContainer) {\r\n  const buttonShowMore = pageItemsColorsContainer.querySelector(\"button\");\r\n  const colors = pageItemsColorsContainer.querySelectorAll(\"div[title]\");\r\n  const SHOW_BLOCKS_COUNT = isMobile ? 10 : 8;\r\n\r\n  let isShow = false;\r\n\r\n  const showLogicHandler = (action = \"hide\") => {\r\n    if (action === \"hide\") {\r\n      isShow = false;\r\n      return colors.forEach(\r\n        (color, i) => i >= SHOW_BLOCKS_COUNT && color.classList.add(\"hidden\")\r\n      );\r\n    }\r\n\r\n    isShow = true;\r\n    return colors.forEach((color) => color.classList.remove(\"hidden\"));\r\n  };\r\n  showLogicHandler();\r\n  buttonShowMore.onclick = () => {\r\n    showLogicHandler(isShow ? \"hide\" : \"show\");\r\n    buttonShowMore.textContent = isShow ? \"скрыть\" : \"показать больше\";\r\n  };\r\n}\r\n\r\nconst pageItemsTabsSwipers = document.querySelectorAll(\r\n  \".page-tabs-products .tabs-block\"\r\n);\r\n\r\npageItemsTabsSwipers?.forEach((container) => {\r\n  const swiper = container.querySelector(\".swiper\");\r\n\r\n  let swiperConfig = {\r\n    slider: swiper,\r\n    slides: 5,\r\n    breakpointsSlides: [2.1, 3, 4, 5],\r\n    space: 20,\r\n  };\r\n\r\n  createAdaptiveSlider(swiperConfig);\r\n});\r\n\r\nconst filtersName = document.querySelectorAll(\".page-results__filter-name\");\r\n\r\nfiltersName?.forEach((header) => {\r\n  const body = header.nextElementSibling;\r\n\r\n  header.onclick = () => {\r\n    header.classList.toggle(\"active\");\r\n    body?.classList.toggle(\"active\");\r\n  };\r\n});\r\nconst faqName = document.querySelectorAll(\".faq__header\");\r\n\r\nfaqName?.forEach((header) => {\r\n  const body = header.nextElementSibling;\r\n\r\n  header.onclick = () => {\r\n    header.classList.toggle(\"active\");\r\n    body?.classList.toggle(\"active\");\r\n  };\r\n});\r\n\r\nconst filtersOpenBtn = document.querySelector(\".page-results__btn-open\");\r\nconst filtersBlock = document.querySelector(\".page-results__aside\");\r\n\r\nif (filtersOpenBtn) {\r\n  filtersOpenBtn.onclick = () => {\r\n    filtersBlock?.classList.add(\"active\");\r\n  };\r\n}\r\nconst filtersCloseBtns = document.querySelectorAll(\"._filters-close\");\r\nfiltersCloseBtns?.forEach((btn) => {\r\n  btn.onclick = () => {\r\n    filtersBlock?.classList.remove(\"active\");\r\n  };\r\n});\r\n\n\n//# sourceURL=webpack://tattoo/./src/js/app.js?");
